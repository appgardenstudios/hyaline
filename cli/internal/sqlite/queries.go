...
CREATE TABLE SYSTEM_CODE(ID, SYSTEM_ID, PATH, PRIMARY KEY (ID, SYSTEM_ID));
CREATE TABLE SYSTEM_FILE(ID, CODE_ID, SYSTEM_ID, ACTION, ORIGINAL_ID, RAW_DATA, PRIMARY KEY (ID, CODE_ID, SYSTEM_ID));
CREATE TABLE SYSTEM_DOCUMENTATION(ID, SYSTEM_ID, TYPE, PATH, PRIMARY KEY (ID, SYSTEM_ID));
CREATE TABLE SYSTEM_DOCUMENT(ID, DOCUMENTATION_ID, SYSTEM_ID, TYPE, ACTION, ORIGINAL_ID, RAW_DATA, EXTRACTED_DATA, PRIMARY KEY (ID, DOCUMENTATION_ID, SYSTEM_ID));
CREATE TABLE SYSTEM_SECTION(ID, DOCUMENT_ID, DOCUMENTATION_ID, SYSTEM_ID, NAME, PARENT_ID, PEER_ORDER, EXTRACTED_DATA, PRIMARY KEY (ID, DOCUMENT_ID, DOCUMENTATION_ID, SYSTEM_ID));
CREATE TABLE SYSTEM_CHANGE(ID, SYSTEM_ID, TYPE, TITLE, BODY, PRIMARY KEY (ID, SYSTEM_ID));
CREATE TABLE SYSTEM_TASK(ID, SYSTEM_ID, TYPE, TITLE, BODY, PRIMARY KEY (ID, SYSTEM_ID));
`)
