...
![Overview](/documentation/03-explanation/_img/extract-change-overview.svg)
...
![Targeting](/documentation/03-explanation/_img/extract-change-target.svg)
...
For more details on the schema of the change data set, including the information captured when extracting changed code, documentation, and change metadata please see the [data set reference]({{< relref "/documentation/04-reference/03-data-set.md" >}}).
...
The extraction process uses the same configuration as the extract current process does, so if you haven't read up on how [extract current]({{< relref "/documentation/03-explanation/02-extract-current.md" >}}) works it would be helpful to do so now.

![Extracting Changed Code](/documentation/03-explanation/_img/extract-change-code.svg)
...
For more details on git extractor options please see the [configuration reference]({{< relref "/documentation/04-reference/01-config.md" >}}).

For more details on the schema of the change data set please see the [data set reference]({{< relref "/documentation/04-reference/03-data-set.md" >}}).
...
![Extract Changed Documentation](/documentation/03-explanation/_img/extract-change-documentation.svg)
...
![Extracting Pull Request](/documentation/03-explanation/_img/extract-change-pull-request.svg)
...
![Extracting Issues](/documentation/03-explanation/_img/extract-change-issues.svg)
...
## Next Steps
You can continue on to see how Hyaline checks [current]({{< relref "/documentation/03-explanation/04-check-current.md" >}}) or [change]({{< relref "/documentation/03-explanation/05-check-change.md" >}}) data sets.