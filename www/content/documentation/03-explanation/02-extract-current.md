...
![Overview](/documentation/03-explanation/_img/extract-current-overview.svg)

In the example above you can see a variety of code and documentation spread over multiple repositories and documentation sites. Hyaline's extraction process can take all of this code and documentation and place it into a single, unified data set organized by system. This data set can then be used to [run checks]({{< relref "/documentation/03-explanation/04-check-current.md" >}}) and support building/maintaining products and systems via an mcp server.
...
## Extracting Code
System source code is extracted for each defined code source in the [configuration]({{< relref "/documentation/04-reference/01-config.md" >}}). Code can be extracted using one of two available extractors: `fs` and `git`.
...
![Extracting Code](/documentation/03-explanation/_img/extract-current-extracting-code.svg)
...
The code that is extracted is placed into a data set that is stored in sqlite. Please see the [data set reference]({{< relref "/documentation/04-reference/03-data-set.md" >}}) for more information.

### Extracting Code - fs
The `fs` extractor extracts source code from the local file system.

![Extracting Code fs](/documentation/03-explanation/_img/extract-current-extracting-code-fs.svg)
...
For more detail on fs extractor options please see the [configuration reference]({{< relref "/documentation/04-reference/01-config.md" >}}).
...
For more detail on git extractor options please see the [configuration reference]({{< relref "/documentation/04-reference/01-config.md" >}}).

### Local Repo
![Local Repo](/documentation/03-explanation/_img/extract-current-local-repo.svg)
...
![Remote Repo Cloned Locally](/documentation/03-explanation/_img/extract-current-remote-repo-cloned-locally.svg)
...
![Remote Repo Cloned Locally](/documentation/03-explanation/_img/extract-current-remote-repo-cloned-in-memory.svg)
...
System documentation is extracted for each defined documentation source in the [configuration]({{< relref "/documentation/04-reference/01-config.md" >}}). Documentation can be extracted using one of three available extractors: `fs`, `git`, and `http`. These 3 extractors are explained below.

![Extracting Documentation](/documentation/03-explanation/_img/extract-current-extracting-documentation.svg)
...
The documentation that is extracted is placed into a data set that is stored in sqlite. Please see the [data set reference]({{< relref "/documentation/04-reference/03-data-set.md" >}}) for more information.

## Documentation Sections

![Extracting Documentation Sections](/documentation/03-explanation/_img/extract-current-extracting-documentation-sections.svg)
...
![HTML to Markdown](/documentation/03-explanation/_img/extract-current-html-to-markdown.svg)
...
![Extracting Documentation fs](/documentation/03-explanation/_img/extract-current-extracting-documentation-fs.svg)
...
![Extracting Documentation git](/documentation/03-explanation/_img/extract-current-extracting-documentation-git.svg)
...
![Extracting Documentation http](/documentation/03-explanation/_img/extract-current-extracting-documentation-http.svg)
...
For more detail on http extractor options please see the [configuration reference]({{< relref "/documentation/04-reference/01-config.md" >}}).

## Extracting Metadata
Hyaline will be extended to extract additional organizational metadata in the future. As of now, Hyaline only supports extracting pull request and issue information when extracting changes. See [Extract Change]({{< relref "/documentation/03-explanation/03-extract-change.md" >}}) for more information.

## Next Steps
You can continue on to see how [Hyaline extracts change information]({{< relref "/documentation/03-explanation/03-extract-change.md" >}}), or see how Hyaline can [merge together data sets]({{< relref "/documentation/03-explanation/08-merge.md" >}}).